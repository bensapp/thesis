...
In the ``strike-a-pose'' parsing method of~\citet{ramanan05}, an easily 
...
scale)~\citep{ramanan05,ferrari08,eichner09, andriluka09}.  In typical video 
...
\citep{bertsekas99,komodakis2007dualdecomp} to solve a linear
