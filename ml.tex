...
\equref{mrf} describes the log of the energy of the system.  When given a 
probabilistic interpretation as we will see in \secref{probinterp}, this type 
...
terms as {\em potentials}, and \equref{mrf} as the negative of an {\em energy 
...
The key insight to be made is the following: knowing where the robot was at 
...
form~\equref{crf} are trained, and restrictions on the form of the potentials.  
...
specific example of the robot localization problem \equref{nesting}, we can 
...
Using \equref{svm}, the second term is piecewise-linear, and we take a 
