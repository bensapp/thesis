...
\newcommand{\abin}{\mathbf{bin}_{uv}}
\newcommand{\dregion}{\mathbf{d}_{region}}
\newcommand{\dcontour}{\mathbf{d}_{contour}}
\newcommand{\setrank}{\textbf{rank}}
\newcommand{\cascade}{\mathcal{C}}
\newcommand{\model}{Local Linear Pictorial Structures}
\newcommand{\mdl}{LLPS}
...
\newcommand{\mmi}{\theta_x^\star(\lpart_i)}
