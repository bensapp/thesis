...
that remain.  This is illustrated in~\figref{cps-overview}.
...
use a model in the form of~\equref{contrib1} at every level of the cascade.  
...
use of our cascade approach developed in~\secref{contrib1}.  Then, we can 
